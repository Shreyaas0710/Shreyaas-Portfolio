...
export function Hero() {
  ...
  // User interaction heart-beat to manage 2.5s inactivity timer
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full h-full min-h-screen max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 items-center gap-12 pt-24 pb-12">
        ...
        <div className="flex flex-col justify-center order-2 lg:order-1 mt-6 lg:mt-0 xl:pl-12">
          {/* Top Intro Badge & Integrated Directional Indicator */}
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mb-6">
            <motion.span
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, delay: 0.1 }}
              className="px-5 py-2 rounded-full border border-border bg-card/50 backdrop-blur-md text-sm font-medium tracking-wide text-muted-foreground shadow-sm"
            >
            ...
            {/* Integrated Directional Indicator with Inactivity Fade */}
            <motion.div
              initial={{ opacity: 0, y: -20 }}
              animate={{ opacity: isInactive ? 0.35 : 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-border/50 bg-card/40 backdrop-blur-md text-xs font-mono shadow-sm"
            >
              <span
                className={`transition-all duration-300 font-bold ${
                  interactionZone === "left"
                    ? "text-cyan-400 scale-105 opacity-100 drop-shadow-[0_0_8px_rgba(0,255,255,0.6)]"
                    : "opacity-40 text-muted-foreground"
                }`}
              >
                ← AI Engineer
              </span>
              <span className="text-muted-foreground/60 text-[10px] font-extrabold tracking-widest px-1">
                MOVE
              </span>
              <span
                className={`transition-all duration-300 font-bold ${
                  interactionZone === "right"
                    ? "text-purple-400 scale-105 opacity-100 drop-shadow-[0_0_8px_rgba(138,43,226,0.6)]"
                    : "opacity-40 text-muted-foreground"
                }`}
              >
                Data Analyst →
            ...
            <AnimatePresence mode="wait">
              {!isDataAnalyst ? (
                ...
                >
                  ...
                  <h1
                    className={`text-6xl md:text-7xl lg:text-8xl font-display font-black text-transparent bg-clip-text bg-gradient-to-br ${PERSONAS.aiEngineer.accentGradient} leading-tight`}
                  >
                ...
                >
                  ...
                  <h1
                    className={`text-6xl md:text-7xl lg:text-8xl font-display font-black text-transparent bg-clip-text bg-gradient-to-br ${PERSONAS.dataAnalyst.accentGradient} leading-tight`}
                  >
          ...
          <motion.div
            ...
            className="mt-10 flex items-center gap-3 text-xs md:text-sm text-muted-foreground font-mono tracking-widest uppercase"
          >
